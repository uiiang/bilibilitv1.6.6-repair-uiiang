...
v260404
- 视频详情页改版，适应大屏电视风格，选集列表改为水平滚动，支持快速分组切换，支持收藏夹选择
- 优化视频列表的筛选排序操作
...
- 动态列表显示头像
- 自定义首页顶部tab
- 修改播放进度条上显示时间格式为时分秒，增强可读性
- 详情页up主头像显示，联合投稿显示全部up主
- 优化搜索结果页
- 不开灯时视频加载页白色背景太晃眼了，改成显示视频封面

v260317
- 播放地址竞速，解决播放视频时等待时间过长的问题
- 为大屏电视优化支持高清图片
- 空降功能兼容android4
...
- [x] 自定义首页顶部tab
- [ ] 自定义直接播放视频或进入详情页
- [x] 修改播放进度条上显示时间格式为时分秒，增强可读性
- [x] 详情页up主头像显示，联合投稿显示全部up主
- [x] 优化搜索结果页
