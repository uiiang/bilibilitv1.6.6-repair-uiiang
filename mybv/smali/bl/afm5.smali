...
.method static synthetic access$000(Lbl/afm5;)Z
    .locals 1
...
.method static synthetic access$100(Lbl/afm5;)Ljava/io/File;
    .locals 1
...
.method static synthetic access$200(Lbl/afm5;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$202(Lbl/afm5;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method private showFolderPicker()V
    ...
    iput-boolean v0, p0, Lbl/afm5;->safAvailable:Z
    :try_end_62
    .catch Ljava/lang/Throwable; {:try_start_47 .. :try_end_62} :catch_2d2
    ...
    const-string v3, "\u7cfb\u7edf\u6587\u4ef6\u7ba1\u7406\u5668\u53ef\u7528: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Lbl/afm5;->safAvailable:Z
    ...
    invoke-virtual {v5, v6}, Landroid/widget/ListView;->setFocusable(Z)V

    .line 423
    const/4 v6, 0x1

    invoke-virtual {v5, v6}, Landroid/widget/ListView;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v6, v7}, Lcom/bilibili/tv/widget/DrawFrameLayout;->setFocusable(Z)V

    .line 433
    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lcom/bilibili/tv/widget/DrawFrameLayout;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v9, v8, v10, v11, v12}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V
    ...
    invoke-direct {v8, v1}, Lcom/bilibili/tv/widget/DrawFrameLayout;-><init>(Landroid/content/Context;)V

    .line 455
    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Lcom/bilibili/tv/widget/DrawFrameLayout;->setFocusable(Z)V

    .line 456
    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Lcom/bilibili/tv/widget/DrawFrameLayout;->setFocusableInTouchMode(Z)V

    .line 457
    const v9, 0x7f0700f0

    invoke-virtual {v8, v9}, Lcom/bilibili/tv/widget/DrawFrameLayout;->setBackgroundResource(I)V

    .line 458
    const v9, 0x7f0700e8

    invoke-virtual {v8, v9}, Lcom/bilibili/tv/widget/DrawFrameLayout;->setUpDrawable(I)V
    ...
    invoke-virtual {v8, v9, v10}, Lcom/bilibili/tv/widget/DrawFrameLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v10, v9, v11, v12, v13}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V

    .line 474
    invoke-virtual {v3, v8, v10}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    .line 477
    new-instance v3, Lbl/afm5$1;

    invoke-direct {v3, p0, v1}, Lbl/afm5$1;-><init>(Lbl/afm5;Landroid/app/Activity;)V

    invoke-virtual {v8, v3}, Lcom/bilibili/tv/widget/DrawFrameLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v2, v9}, Landroid/view/Window;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v2, v9, v10}, Landroid/view/Window;->setFlags(II)V
    ...
    const-string v10, "\u6587\u4ef6\u5939\u9009\u62e9\u5bf9\u8bdd\u6846\u5df2\u663e\u793a\uff0c\u9ed8\u8ba4\u76ee\u5f55: "
    ...
    invoke-direct {v0, p0, v1}, Lbl/afm5$2;-><init>(Lbl/afm5;Landroid/app/Activity;)V
    ...
    invoke-direct {v0, p0, v5, v6}, Lbl/afm5$3;-><init>(Lbl/afm5;Landroid/widget/ListView;Lcom/bilibili/tv/widget/DrawFrameLayout;)V
    ...
    invoke-direct {v0, p0, v5, v8}, Lbl/afm5$4;-><init>(Lbl/afm5;Landroid/widget/ListView;Lcom/bilibili/tv/widget/DrawFrameLayout;)V
    ...
    invoke-direct {v0, p0, v6}, Lbl/afm5$5;-><init>(Lbl/afm5;Lcom/bilibili/tv/widget/DrawFrameLayout;)V
    ...
    invoke-direct {v0, p0, v8}, Lbl/afm5$6;-><init>(Lbl/afm5;Lcom/bilibili/tv/widget/DrawFrameLayout;)V
    ...
    invoke-direct {v0, p0, v6, v7}, Lbl/afm5$7;-><init>(Lbl/afm5;Lcom/bilibili/tv/widget/DrawFrameLayout;Landroid/widget/TextView;)V
    ...
    invoke-direct {v0, p0, v5}, Lbl/afm5$8;-><init>(Lbl/afm5;Landroid/widget/ListView;)V
