...
import com.bilibili.tv.ui.favorite.boxlist.BoxListInfoActivity3;
...
public final class aed3 extends ady {
    ...
    private final void b() {
        ((MyBiliApiService) vo.a(MyBiliApiService.class)).getFavoritePugv(1, 50, Long.valueOf(mg.a(getActivity()).d()), "SESSDATA=" + mg.a(getActivity()).getSESSDATA()).a(this.d);
    }
    ...
    public final class a extends vn<JSONObject> {
        ...
        public /* bridge */ /* synthetic */ void a(JSONObject result) {
            ...
            aed3.this.j();
            if (aed3.this.c.a()!=0 || result.getJSONArray("items").size()!=0) {
                aed3.this.c.a(result.getJSONArray("items"));
                return;
            }
            aed3.this.l();
            aed3.this.a(R.string.nothing_show);
        }

        @Override // bl.vm
        public boolean isCancel() {
            return !aed3.this.isAdded();
        }

        @Override // bl.vm
        public void onError(Throwable th) {
            bbi.b(th, "t");
            adl.a.a(th, aed3.this.getActivity());
            if (aed3.this.c == null) {
                return;
            }
            aed3.this.k();
    ...
    public static final class b extends RecyclerView.a<adv> {
        ...
        public void a(adv advVar, int i) {
            ...
            if (advVar instanceof c) {
                ...
                if (biliFavoriteBox.getIntValue("ep_count") <= 999) {
                    ((c) advVar).B().setText(String.valueOf(biliFavoriteBox.getIntValue("ep_count")));
                } else {
        ...
        public void onClick(View view) {
            ...
            if (a2 != null) {
                ...
                if ((tag instanceof JSONObject) && (tag2 instanceof Integer)) {
                    ...
                    BoxListInfoActivity3.Companion.a(a2, biliFavoriteBox.getLong("season_id"), 0L, biliFavoriteBox.getString("title"));
                    ok.a("tv_myfavourite_fold_click", "row", String.valueOf(((int) Math.floor(((Number) tag2).intValue() / aed3.f)) + 1));
                }
            }
        }
