...
public class aef2 extends ady {
    ...
    static /* synthetic */ int e(aef2 aef2Var) {
        int i = aef2Var.f;
        aef2Var.f = i + 1;
        return i;
    }

    public static aef2 b() {
        return new aef2();
    }
    ...
    public void a(RecyclerView recyclerView, @Nullable Bundle bundle) {
        ...
        recyclerView.a(new RecyclerView.g() { // from class: bl.aef2.2
        ...
        recyclerView.a(new RecyclerView.m() { // from class: bl.aef2.3
            @Override // android.support.v7.widget.RecyclerView.m
            public void a(RecyclerView recyclerView2, int i) {
                super.a(recyclerView2, i);
                if (!aef2.this.g || aef2.this.h || aef2.this.c == null) {
                    return;
                }
    ...
    class a extends vn<JSONObject> {
        ...
        public /* synthetic */ void a(JSONObject response) {
            ...
            if (aef2.this.f == 1) {
                aef2.this.l();
                aef2.this.a(R.string.nothing_show);
            }
            aef2.this.g = false;
        }
