...
public class aef4 extends ady {
    ...
    public void a(RecyclerView recyclerView, @Nullable Bundle bundle) {
        ...
        recyclerView.a(new RecyclerView.g() { // from class: bl.aef4.2
    ...
    class a extends vn<JSONObject> {
        ...
        public /* synthetic */ void a(JSONObject response) {
            ...
            if (aef4.this.c.a() != 0 || (response != null && response.getJSONArray("list")!=null)) {
                ...
                aef4.this.l();
                aef4.this.a(R.string.nothing_show);
            }
            aef4.this.g = false;
        }
