...
public final class FollowPgcActivity extends BaseReloadActivity implements wf {
    ...
    public static final class a {
        ...
        public final void a(Context context) {
            ...
            intent = new Intent(context, (Class<?>) FollowPgcActivity.class);
    ...
    public static final class e extends RecyclerView.g {
        ...
        public void a(Rect rect, View view, RecyclerView recyclerView, RecyclerView.s sVar) {
            ...
            if (recyclerView.g(view) < FollowPgcActivity.h) {
    ...
    final class b extends vm<BangumiApiPageResponse<List<BiliBangumiSeason>>> {
        ...
        public boolean isCancel() {
            return FollowPgcActivity.this.isFinishing();
        }
        ...
        public void onSuccess(BangumiApiPageResponse<List<BiliBangumiSeason>> bangumiApiPageResponse) {
            if (FollowPgcActivity.this.a == null || FollowPgcActivity.this.c == null) {
                return;
            }
            FollowPgcActivity.this.g = false;
            FollowPgcActivity.this.a(false);
            FollowPgcActivity.this.c.b();
            if (bangumiApiPageResponse == null || bangumiApiPageResponse.result == null || bangumiApiPageResponse.result.isEmpty()) {
                if (FollowPgcActivity.this.e == 1) {
                    FollowPgcActivity.this.c.c();
                    FollowPgcActivity.this.c.a(R.string.nothing_show);
                    return;
                }
                return;
            }
            if (FollowPgcActivity.this.e >= bangumiApiPageResponse.pages) {
        ...
        public void onError(Throwable t) {
            bbi.b(t, "t");
            adl.a.a(t, FollowPgcActivity.this);
            if (FollowPgcActivity.this.a == null || FollowPgcActivity.this.c == null) {
                return;
            }
            FollowPgcActivity.this.g = false;
            if (FollowPgcActivity.this.e == 1) {
                FollowPgcActivity.this.a(true);
                FollowPgcActivity.this.c.setRefreshError(true);
            }
        }
    }


    final class FollowPgcResponse extends vn<JSONObject> {
        @Override // bl.vm
        public boolean isCancel() {
            return FollowPgcActivity.this.isFinishing();
        }
    ...
    static final class d extends adv implements View.OnClickListener, View.OnFocusChangeListener {
        ...
        public void onClick(View view) {
            ...
            ok.a("tv_mybangumi_click", "title", biliBangumiSeason.mTitle, "bangumiid", biliBangumiSeason.mBangumiId, "row", String.valueOf(((int) Math.floor(((Number) tag2).intValue() / FollowPgcActivity.h)) + 1));
        }
