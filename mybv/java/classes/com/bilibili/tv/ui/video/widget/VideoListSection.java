...
public class VideoListSection extends LinearLayout {
    ...
    private void initViews() {
        ...
        adapter.setOnItemClickListener(new VideoCardAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Object data, int position) {
                ...
                if (currentVideoId > 0 && adapter.getBinder() != null && data != null) {
    ...
    public boolean hasData() {
        ...
        Log.d(TAG, "hasData | sectionId=" + sectionId + " | result=" + result
    ...
    public void setOnVideoClickListener(OnVideoClickListener listener) {
        ...
        Log.d(TAG, "setOnVideoClickListener | sectionId=" + sectionId
                + " | listener=" + (listener != null ? "已设置" : "null"));
    }
