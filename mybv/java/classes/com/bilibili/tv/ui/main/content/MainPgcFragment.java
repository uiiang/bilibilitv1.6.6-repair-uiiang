...
public final class MainPgcFragment extends adu implements aez, wf {
    public static final c Companion = new c(null);
    private static final String e = "MainPgcFragment";
    ...
    public static final class c {
        ...
        public final MainPgcFragment a() {
            return new MainPgcFragment();
        }
    }
    ...
    public void a(RecyclerView recyclerView, Bundle bundle) {
        ...
        this.a = new BorderGridLayoutManager(activity, i, i2, z) { // from class: com.bilibili.tv.ui.main.content.MainPgcFragment$onViewCreated$1
            @Override // android.support.v7.widget.RecyclerView.h
            public View d(View view, int i3) {
                int d2 = d(view);
                if (i3 == 33 && d2 < 4) {
                    FragmentActivity activity2 = MainPgcFragment.this.getActivity();
                    if (activity2 == null) {
        ...
        this.c = new a();
        //((kh) vo.a(kh.class)).b().a(this.c);
        //https://api.bilibili.com/pgc/page/pc/cinema/tab?is_refresh=0&cursor=0
        ((MyBiliApiService) vo.a(MyBiliApiService.class)).getPgcInfos().a(this.c);
    }
    ...
    public static final class g extends RecyclerView.g {
        ...
        public void a(Rect rect, View view, RecyclerView recyclerView, RecyclerView.s sVar) {
            ...
            int top = f < MainPgcFragment.f ? 0 : this.a;
            int bottom = this.a;
            int mod = f % MainPgcFragment.f;
            int spacing = this.a;
            int halfSpacing = spacing / 2;
            
            int left = halfSpacing - (mod * spacing) / MainPgcFragment.f;
            int right = ((mod + 1) * spacing) / MainPgcFragment.f - halfSpacing;
    ...
    /* compiled from: BL */
    final class a extends vm<JSONObject> {
        ...
        public boolean isCancel() {
            return MainPgcFragment.this.getActivity() == null || MainPgcFragment.this.b == null;
        }

        @Override // bl.vm
        public void onError(Throwable th) {
            bbi.b(th, "t");
            adl.a.a(th, MainPgcFragment.this.getActivity());
        }
    }
    ...
    static final class b extends RecyclerView.a<adv> {
        ...
        private final int[] b;
        private final int[] c;
        private final WeakReference<MainPgcFragment> d;
        ...
        public b(MainPgcFragment MainPgcFragmentVar) {
            bbi.b(MainPgcFragmentVar, "bangumiFragment");
            this.a = new int[]{R.string.pgc_main_follow, R.string.area_movie, R.string.area_tv, R.string.area_doc};
            this.b = new int[]{R.color.color_2, R.color.color_1, R.color.color_5, R.color.color_3};
            this.c = new int[]{R.drawable.ic_bangumi_favourite, R.drawable.ic_movie, R.drawable.ic_tv, R.drawable.ic_doc};
            this.d = new WeakReference<>(MainPgcFragmentVar);
            this.e = new ArrayList<>();
            this.f = new JSONArray(6);
        ...
        public void a(adv advVar, int i) {
            ...
            if (advVar instanceof e) {
                ...
                JSONObject content = this.f.getJSONObject(i - MainPgcFragment.f);
                if (!TextUtils.isEmpty(content.getString("title"))) {
    ...
    static final class d extends adv implements View.OnClickListener, View.OnFocusChangeListener {
        ...
        private final WeakReference<MainPgcFragment> q;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(View view, WeakReference<MainPgcFragment> weakReference) {
            super(view);
            bbi.b(view, "itemView");
            bbi.b(weakReference, "mMainPgcFragmentWeakReference");
        ...
        public static final class a {
            ...
            public final d a(ViewGroup viewGroup, WeakReference<MainPgcFragment> weakReference) {
                bbi.b(viewGroup, "parent");
        ...
        public void onClick(View view) {
            ...
            switch (intValue) {
                case 0:
                    ...
                    break;
                case 1:
                    AreaActivity.Companion.a(a2, 23);
                    break;
                case 2:
                    AreaActivity.Companion.a(a2, 11);
                    break;
                case 3:
                    AreaActivity.Companion.a(a2, 177);
                    break;
            }
        }
        ...
        public void onFocusChange(View view, boolean z) {
            bbi.b(view, "v");
            MainPgcFragment MainPgcFragmentVar = this.q.get();
            Object tag = view.getTag(R.id.position);
            if (MainPgcFragmentVar == null || tag == null) {
                return;
            }
            MainPgcFragmentVar.d = ((Integer) tag).intValue();
            adj.a(view, z);
    ...
    static final class e extends adv implements View.OnClickListener, View.OnFocusChangeListener {
        ...
        private final WeakReference<MainPgcFragment> r;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(View view, WeakReference<MainPgcFragment> weakReference) {
            super(view);
            bbi.b(view, "itemView");
            bbi.b(weakReference, "mMainPgcFragmentWeakReference");
        ...
        public static final class a {
            ...
            public final e a(ViewGroup viewGroup, WeakReference<MainPgcFragment> weakReference) {
                bbi.b(viewGroup, "parent");
                bbi.b(weakReference, "weakReference");
        ...
        public void onClick(View view) {
            ...
            if (a2 == null || tag == null || !(tag instanceof JSONObject)) {
                return;
            }
        ...
        public void onFocusChange(View view, boolean z) {
            bbi.b(view, "v");
            MainPgcFragment MainPgcFragmentVar = this.r.get();
            Object tag = view.getTag(R.id.position);
            if (MainPgcFragmentVar == null || tag == null) {
                return;
            }
