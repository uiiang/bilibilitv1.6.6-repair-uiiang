...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;->getInitialBitrateEstimatesForCountry(Ljava/lang/String;)Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;->initialBitrateEstimates:Ljava/util/Map;

    .line 140
    new-instance v0, Lcom/google/android/exoplayer2/upstream/experimental/PercentileTimeToFirstByteEstimator;

    const/16 v1, 0x14

    const/high16 v2, 0x3f000000    # 0.5f

    invoke-direct {v0, v1, v2}, Lcom/google/android/exoplayer2/upstream/experimental/PercentileTimeToFirstByteEstimator;-><init>(IF)V

    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;->timeToFirstByteEstimator:Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;

    .line 144
    new-instance v0, Lcom/google/android/exoplayer2/upstream/experimental/SplitParallelSampleBandwidthEstimator$Builder;

    invoke-direct {v0}, Lcom/google/android/exoplayer2/upstream/experimental/SplitParallelSampleBandwidthEstimator$Builder;-><init>()V

    invoke-virtual {v0}, Lcom/google/android/exoplayer2/upstream/experimental/SplitParallelSampleBandwidthEstimator$Builder;->build()Lcom/google/android/exoplayer2/upstream/experimental/SplitParallelSampleBandwidthEstimator;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;->bandwidthEstimator:Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;

    .line 145
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;->resetOnNetworkTypeChange:Z
...
.method private static getInitialBitrateEstimatesForCountry(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 247
    # invokes: Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->getInitialBitrateCountryGroupAssignment(Ljava/lang/String;)[I
    ...
    sget-object v5, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI:Lcom/google/common/collect/ImmutableList;
    ...
    sget-object v6, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_2G:Lcom/google/common/collect/ImmutableList;
    ...
    sget-object v7, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_3G:Lcom/google/common/collect/ImmutableList;
    ...
    sget-object v7, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_4G:Lcom/google/common/collect/ImmutableList;
    ...
    sget-object v6, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA:Lcom/google/common/collect/ImmutableList;
    ...
    sget-object v5, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter;->DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA:Lcom/google/common/collect/ImmutableList;
...
.method public setBandwidthEstimator(Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;)Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;
    .registers 2
    .param p1, "bandwidthEstimator"    # Lcom/google/android/exoplayer2/upstream/experimental/BandwidthEstimator;
...
.method public setInitialBitrateEstimate(J)Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;
    ...
    invoke-virtual {p0, v2, p1, p2}, Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;->setInitialBitrateEstimate(IJ)Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;
...
.method public setTimeToFirstByteEstimator(Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;)Lcom/google/android/exoplayer2/upstream/experimental/ExperimentalBandwidthMeter$Builder;
    .registers 2
    .param p1, "timeToFirstByteEstimator"    # Lcom/google/android/exoplayer2/upstream/TimeToFirstByteEstimator;
